...
public class HttpClientTest {
    ...
    public void doGetWithParam() throws Exception{
        ...
        uriBuilder.addParameter("wd","nice");
    ...
    public void doPostWithParam() throws IOException {
        ...
        String password = new String("张三");
      //  password.getBytes("utf-8");
        kvList.add(new BasicNameValuePair("username","nice"));
        kvList.add(new BasicNameValuePair("password","张三"));
        //包装成一个Entity对象
